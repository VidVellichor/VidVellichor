...
| --- | --- | --- | --- |
| [**AstraQueue**](https://astra-queue.vercel.app) | Real-time school queue & leave-permission system. Public display board, admin console, violation ledger — no app server, all authorization enforced by Postgres row-level security. | React 18 · Vite · Tailwind · Supabase | Live · [source](https://github.com/VidVellichor/AstraQueue) |
